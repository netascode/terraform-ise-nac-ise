      ...
      children = try([for i in ps.condition.children : {
        ...
        children = try([for j in i.children : {
          ...
          children = try([for k in j.children : {
            ...
            dictionary_name  = try(k.dictionary_name, local.defaults.ise.device_administration.policy_sets.condition.dictionary_name, null)
            dictionary_value = try(k.dictionary_value, local.defaults.ise.device_administration.policy_sets.condition.dictionary_value, null)
            ...
            children = try([for l in k.children : {
              ...
              dictionary_name  = try(l.dictionary_name, local.defaults.ise.device_administration.policy_sets.condition.dictionary_name, null)
              dictionary_value = try(l.dictionary_value, local.defaults.ise.device_administration.policy_sets.condition.dictionary_value, null)
              ...
              children = try([for m in l.children : {
                ...
                dictionary_name  = try(m.dictionary_name, local.defaults.ise.device_administration.policy_sets.condition.dictionary_name, null)
                dictionary_value = try(m.dictionary_value, local.defaults.ise.device_administration.policy_sets.condition.dictionary_value, null)
                ...
                children = try([for n in m.children : {
                  ...
                  dictionary_name  = try(n.dictionary_name, local.defaults.ise.device_administration.policy_sets.condition.dictionary_name, null)
                  dictionary_value = try(n.dictionary_value, local.defaults.ise.device_administration.policy_sets.condition.dictionary_value, null)
                  ...
                  children = try([for o in n.children : {
                    attribute_name   = try(o.attribute_name, local.defaults.ise.device_administration.policy_sets.condition.attribute_name, null)
                    attribute_value  = try(o.attribute_value, local.defaults.ise.device_administration.policy_sets.condition.attribute_value, null)
                    dictionary_name  = try(o.dictionary_name, local.defaults.ise.device_administration.policy_sets.condition.dictionary_name, null)
                    dictionary_value = try(o.dictionary_value, local.defaults.ise.device_administration.policy_sets.condition.dictionary_value, null)
                    condition_type   = try(o.type, local.defaults.ise.device_administration.policy_sets.condition.type, null)
                    is_negate        = try(o.is_negate, local.defaults.ise.device_administration.policy_sets.condition.is_negate, null)
                    operator         = try(o.operator, local.defaults.ise.device_administration.policy_sets.condition.operator, null)
                    id               = contains(local.known_conditions_device_admin, try(o.name, "")) ? ise_device_admin_condition.device_admin_condition[o.name].id : try(data.ise_device_admin_condition.device_admin_condition[o.name].id, null)
                  }], null)
                }], null)
              }], null)
            }], null)
        ...
        children = try([for i in rule.condition.children : {
          ...
          children = try([for j in i.children : {
            ...
            children = try([for k in j.children : {
              ...
              dictionary_name  = try(k.dictionary_name, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_name, null)
              dictionary_value = try(k.dictionary_value, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_value, null)
              ...
              children = try([for l in k.children : {
                ...
                dictionary_name  = try(l.dictionary_name, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_name, null)
                dictionary_value = try(l.dictionary_value, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_value, null)
                ...
                children = try([for m in l.children : {
                  ...
                  dictionary_name  = try(m.dictionary_name, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_name, null)
                  dictionary_value = try(m.dictionary_value, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_value, null)
                  ...
                  children = try([for n in m.children : {
                    ...
                    dictionary_name  = try(n.dictionary_name, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_name, null)
                    dictionary_value = try(n.dictionary_value, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_value, null)
                    ...
                    id               = contains(local.known_conditions_device_admin, try(n.name, "")) ? ise_device_admin_condition.device_admin_condition[n.name].id : try(data.ise_device_admin_condition.device_admin_condition[n.name].id, null)
                    children = try([for o in n.children : {
                      attribute_name   = try(o.attribute_name, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.attribute_name, null)
                      attribute_value  = try(o.attribute_value, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.attribute_value, null)
                      dictionary_name  = try(o.dictionary_name, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_name, null)
                      dictionary_value = try(o.dictionary_value, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.dictionary_value, null)
                      condition_type   = try(o.type, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.type, null)
                      is_negate        = try(o.is_negate, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.is_negate, null)
                      operator         = try(o.operator, local.defaults.ise.device_administration.policy_sets.authentication_rules.condition.operator, null)
                      id               = contains(local.known_conditions_device_admin, try(o.name, "")) ? ise_device_admin_condition.device_admin_condition[o.name].id : try(data.ise_device_admin_condition.device_admin_condition[o.name].id, null)
                    }], null)
                  }], null)
                }], null)
...
locals {
        ...
        children = try([for i in rule.condition.children : {
          ...
          children = try([for j in i.children : {
            ...
            children = try([for k in j.children : {
              ...
              dictionary_name  = try(k.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_name, null)
              dictionary_value = try(k.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_value, null)
              ...
              children = try([for l in k.children : {
                ...
                dictionary_name  = try(l.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_name, null)
                dictionary_value = try(l.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_value, null)
                ...
                children = try([for m in l.children : {
                  ...
                  dictionary_name  = try(m.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_name, null)
                  dictionary_value = try(m.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_value, null)
                  ...
                  children = try([for n in m.children : {
                    ...
                    dictionary_name  = try(n.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_name, null)
                    dictionary_value = try(n.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_value, null)
                    ...
                    id               = contains(local.known_conditions_device_admin, try(n.name, "")) ? ise_device_admin_condition.device_admin_condition[n.name].id : try(data.ise_device_admin_condition.device_admin_condition[n.name].id, null)
                    children = try([for o in n.children : {
                      attribute_name   = try(o.attribute_name, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.attribute_name, null)
                      attribute_value  = try(o.attribute_value, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.attribute_value, null)
                      dictionary_name  = try(o.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_name, null)
                      dictionary_value = try(o.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.dictionary_value, null)
                      condition_type   = try(o.type, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.type, null)
                      is_negate        = try(o.is_negate, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.is_negate, null)
                      operator         = try(o.operator, local.defaults.ise.device_administration.policy_sets.authorization_rules.condition.operator, null)
                      id               = contains(local.known_conditions_device_admin, try(o.name, "")) ? ise_device_admin_condition.device_admin_condition[o.name].id : try(data.ise_device_admin_condition.device_admin_condition[o.name].id, null)
                    }], null)
                  }], null)
                }], null)
  ...
  device_admin_authorization_rules_by_policy_name = {
    for policy_name in distinct([
...
locals {
        ...
        children = try([for i in rule.condition.children : {
          ...
          children = try([for j in i.children : {
            ...
            children = try([for k in j.children : {
              ...
              dictionary_name  = try(k.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_name, null)
              dictionary_value = try(k.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_value, null)
              ...
              children = try([for l in k.children : {
                ...
                dictionary_name  = try(l.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_name, null)
                dictionary_value = try(l.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_value, null)
                ...
                children = try([for m in l.children : {
                  ...
                  dictionary_name  = try(m.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_name, null)
                  dictionary_value = try(m.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_value, null)
                  ...
                  children = try([for n in m.children : {
                    ...
                    dictionary_name  = try(n.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_name, null)
                    dictionary_value = try(n.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_value, null)
                    ...
                    id               = contains(local.known_conditions_device_admin, try(n.name, "")) ? ise_device_admin_condition.device_admin_condition[n.name].id : try(data.ise_device_admin_condition.device_admin_condition[n.name].id, null)
                    children = try([for o in n.children : {
                      attribute_name   = try(o.attribute_name, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.attribute_name, null)
                      attribute_value  = try(o.attribute_value, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.attribute_value, null)
                      dictionary_name  = try(o.dictionary_name, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_name, null)
                      dictionary_value = try(o.dictionary_value, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.dictionary_value, null)
                      condition_type   = try(o.type, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.type, null)
                      is_negate        = try(o.is_negate, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.is_negate, null)
                      operator         = try(o.operator, local.defaults.ise.device_administration.policy_sets.authorization_exception_rules.condition.operator, null)
                      id               = contains(local.known_conditions_device_admin, try(o.name, "")) ? ise_device_admin_condition.device_admin_condition[o.name].id : try(data.ise_device_admin_condition.device_admin_condition[o.name].id, null)
                    }], null)
                  }], null)
                }], null)
  ...
  device_admin_authorization_exception_rules_by_policy_name = {
    for policy_name in distinct([
      ...
      children = try([for i in rule.condition.children : {
        ...
        children = try([for j in i.children : {
          ...
          children = try([for k in j.children : {
            ...
            dictionary_name  = try(k.dictionary_name, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_name, null)
            dictionary_value = try(k.dictionary_value, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_value, null)
            ...
            children = try([for l in k.children : {
              ...
              dictionary_name  = try(l.dictionary_name, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_name, null)
              dictionary_value = try(l.dictionary_value, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_value, null)
              ...
              children = try([for m in l.children : {
                ...
                dictionary_name  = try(m.dictionary_name, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_name, null)
                dictionary_value = try(m.dictionary_value, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_value, null)
                ...
                children = try([for n in m.children : {
                  ...
                  dictionary_name  = try(n.dictionary_name, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_name, null)
                  dictionary_value = try(n.dictionary_value, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_value, null)
                  ...
                  id               = contains(local.known_conditions_device_admin, try(n.name, "")) ? ise_device_admin_condition.device_admin_condition[n.name].id : try(data.ise_device_admin_condition.device_admin_condition[n.name].id, null)
                  children = try([for o in n.children : {
                    attribute_name   = try(o.attribute_name, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.attribute_name, null)
                    attribute_value  = try(o.attribute_value, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.attribute_value, null)
                    dictionary_name  = try(o.dictionary_name, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_name, null)
                    dictionary_value = try(o.dictionary_value, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.dictionary_value, null)
                    condition_type   = try(o.type, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.type, null)
                    is_negate        = try(o.is_negate, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.is_negate, null)
                    operator         = try(o.operator, local.defaults.ise.device_administration.authorization_global_exception_rules.condition.operator, null)
                    id               = contains(local.known_conditions_device_admin, try(o.name, "")) ? ise_device_admin_condition.device_admin_condition[o.name].id : try(data.ise_device_admin_condition.device_admin_condition[o.name].id, null)
                  }], null)
                }], null)
              }], null)
