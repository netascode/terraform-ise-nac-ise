...
resource "ise_internal_user" "internal_user" {
  ...
  password                   = try(each.value.password_version, local.defaults.ise.identity_management.internal_users.password_version, null) == null ? try(each.value.password, local.defaults.ise.identity_management.internal_users.password, null) : null
  password_wo                = try(each.value.password_version, local.defaults.ise.identity_management.internal_users.password_version, null) == null ? null : try(each.value.password, local.defaults.ise.identity_management.internal_users.password, null)
  ...
  enable_password            = try(each.value.enable_password_version, local.defaults.ise.identity_management.internal_users.enable_password_version, null) == null ? try(each.value.enable_password, local.defaults.ise.identity_management.internal_users.enable_password, null) : null
  enable_password_wo         = try(each.value.enable_password_version, local.defaults.ise.identity_management.internal_users.enable_password_version, null) == null ? null : try(each.value.enable_password, local.defaults.ise.identity_management.internal_users.enable_password, null)
