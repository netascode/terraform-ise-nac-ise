...
resource "ise_network_device" "network_device" {
  ...
  authentication_radius_shared_secret                      = try(each.value.radius.shared_secret_version, local.defaults.ise.network_resources.network_devices.radius.shared_secret_version, null) == null ? try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null) : null
  authentication_radius_shared_secret_wo                   = try(each.value.radius.shared_secret_version, local.defaults.ise.network_resources.network_devices.radius.shared_secret_version, null) == null ? null : try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null)
  ...
  snmp_auth_password                                          = try(each.value.snmp.auth_password_version, local.defaults.ise.network_resources.network_devices.snmp.auth_password_version, null) == null ? (local.network_device_snmp_configured[each.key] ? try(each.value.snmp.auth_password, local.defaults.ise.network_resources.network_devices.snmp.auth_password, null) : null) : null
  snmp_auth_password_wo                                       = try(each.value.snmp.auth_password_version, local.defaults.ise.network_resources.network_devices.snmp.auth_password_version, null) == null ? null : (local.network_device_snmp_configured[each.key] ? try(each.value.snmp.auth_password, local.defaults.ise.network_resources.network_devices.snmp.auth_password, null) : null)
  ...
  snmp_privacy_password                                       = try(each.value.snmp.privacy_password_version, local.defaults.ise.network_resources.network_devices.snmp.privacy_password_version, null) == null ? (local.network_device_snmp_configured[each.key] ? try(each.value.snmp.privacy_password, local.defaults.ise.network_resources.network_devices.snmp.privacy_password, null) : null) : null
  snmp_privacy_password_wo                                    = try(each.value.snmp.privacy_password_version, local.defaults.ise.network_resources.network_devices.snmp.privacy_password_version, null) == null ? null : (local.network_device_snmp_configured[each.key] ? try(each.value.snmp.privacy_password, local.defaults.ise.network_resources.network_devices.snmp.privacy_password, null) : null)
  ...
  tacacs_shared_secret                                        = try(each.value.tacacs.shared_secret_version, local.defaults.ise.network_resources.network_devices.tacacs.shared_secret_version, null) == null ? try(each.value.tacacs.shared_secret, local.defaults.ise.network_resources.network_devices.tacacs.shared_secret, null) : null
  tacacs_shared_secret_wo                                     = try(each.value.tacacs.shared_secret_version, local.defaults.ise.network_resources.network_devices.tacacs.shared_secret_version, null) == null ? null : try(each.value.tacacs.shared_secret, local.defaults.ise.network_resources.network_devices.tacacs.shared_secret, null)
