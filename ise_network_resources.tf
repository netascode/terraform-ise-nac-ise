locals {
  network_device_groups = [for group in try(local.ise.network_resources.network_device_groups, []) : {
    name        = try(split("#", group.path)[0] == "All Device Types", false) ? "Device Type#${group.path}#${group.name}" : (try(split("#", group.path)[0] == "All Locations", false) ? "Location#${group.path}#${group.name}" : (try(split("#", group.path)[0] == "Is IPSEC Device", false) ? "IPSEC#${group.path}#${group.name}" : (try(group.path, null) == null ? "${group.name}#${group.name}" : (length(split("#", group.path)) == 1 ? "${group.path}#${group.name}" : "${split("#", group.path)[0]}#${group.path}#${group.name}"))))
...
locals {
  network_device_groups_children = flatten([for p in try(local.ise.network_resources.network_device_groups, []) : [
    for c in try(p.children, []) : {
      name        = try(split("#", p.path)[0] == "All Device Types", false) ? "Device Type#${p.path}#${p.name}#${c.name}" : (try(split("#", p.path)[0] == "All Locations", false) ? "Location#${p.path}#${p.name}#${c.name}" : (try(split("#", p.path)[0] == "Is IPSEC Device", false) ? "IPSEC#${p.path}#${p.name}#${c.name}" : (try(p.path, null) == null ? "${p.name}#${p.name}#${c.name}" : (length(split("#", p.path)) == 1 ? "${p.path}#${p.name}#${c.name}" : "${split("#", p.path)[0]}#${p.path}#${p.name}#${c.name}"))))
  ...
  network_device_groups_children_children = flatten([for p in try(local.ise.network_resources.network_device_groups, []) : [
    for c in try(p.children, []) : [
      for c2 in try(c.children, []) : {
        name        = try(split("#", p.path)[0] == "All Device Types", false) ? "Device Type#${p.path}#${p.name}#${c.name}#${c2.name}" : (try(split("#", p.path)[0] == "All Locations", false) ? "Location#${p.path}#${p.name}#${c.name}#${c2.name}" : (try(split("#", p.path)[0] == "Is IPSEC Device", false) ? "IPSEC#${p.path}#${p.name}#${c.name}#${c2.name}" : (try(p.path, null) == null ? "${p.name}#${p.name}#${c.name}#${c2.name}" : (length(split("#", p.path)) == 1 ? "${p.path}#${p.name}#${c.name}#${c2.name}" : "${split("#", p.path)[0]}#${p.path}#${p.name}#${c.name}#${c2.name}"))))
    ...
    for c in try(p.children, []) : [
      for c2 in try(c.children, []) : [
        for c3 in try(c2.children, []) : {
          name        = try(split("#", p.path)[0] == "All Device Types", false) ? "Device Type#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}" : (try(split("#", p.path)[0] == "All Locations", false) ? "Location#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}" : (try(split("#", p.path)[0] == "Is IPSEC Device", false) ? "IPSEC#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}" : (try(p.path, null) == null ? "${p.name}#${p.name}#${c.name}#${c2.name}#${c3.name}" : (length(split("#", p.path)) == 1 ? "${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}" : "${split("#", p.path)[0]}#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}"))))
          description = try(c.description, local.defaults.ise.network_resources.network_device_groups.description, null)
          root_group  = try(split("#", p.path)[0] == "All Device Types", false) ? "Device Type" : (try(split("#", p.path)[0] == "All Locations", false) ? "Location" : (try(split("#", p.path)[0] == "Is IPSEC Device", false) ? "IPSEC" : try(split("#", p.path)[0], p.name)))
        }
      ]
      ...
      for c2 in try(c.children, []) : [
        for c3 in try(c2.children, []) : [
          for c4 in try(c3.children, []) : {
            name        = try(split("#", p.path)[0] == "All Device Types", false) ? "Device Type#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}" : (try(split("#", p.path)[0] == "All Locations", false) ? "Location#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}" : (try(split("#", p.path)[0] == "Is IPSEC Device", false) ? "IPSEC#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}" : (try(p.path, null) == null ? "${p.name}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}" : (length(split("#", p.path)) == 1 ? "${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}" : "${split("#", p.path)[0]}#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}"))))
            description = try(c.description, local.defaults.ise.network_resources.network_device_groups.description, null)
            root_group  = try(split("#", p.path)[0] == "All Device Types", false) ? "Device Type" : (try(split("#", p.path)[0] == "All Locations", false) ? "Location" : (try(split("#", p.path)[0] == "Is IPSEC Device", false) ? "IPSEC" : try(split("#", p.path)[0], p.name)))
          }
        ]
        ...
        for c3 in try(c2.children, []) : [
          for c4 in try(c3.children, []) : [
            for c5 in try(c4.children, []) : {
              name        = try(split("#", p.path)[0] == "All Device Types", false) ? "Device Type#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}#${c5.name}" : (try(split("#", p.path)[0] == "All Locations", false) ? "Location#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}#${c5.name}" : (try(split("#", p.path)[0] == "Is IPSEC Device", false) ? "IPSEC#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}#${c5.name}" : (try(p.path, null) == null ? "${p.name}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}#${c5.name}" : (length(split("#", p.path)) == 1 ? "${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}#${c5.name}" : "${split("#", p.path)[0]}#${p.path}#${p.name}#${c.name}#${c2.name}#${c3.name}#${c4.name}#${c5.name}"))))
              description = try(c.description, local.defaults.ise.network_resources.network_device_groups.description, null)
              root_group  = try(split("#", p.path)[0] == "All Device Types", false) ? "Device Type" : (try(split("#", p.path)[0] == "All Locations", false) ? "Location" : (try(split("#", p.path)[0] == "Is IPSEC Device", false) ? "IPSEC" : try(split("#", p.path)[0], p.name)))
            }
          ]
...
resource "ise_network_device" "network_device" {
  ...
  authentication_encryption_key                            = try(each.value.radius.encryption_key_version, local.defaults.ise.network_resources.network_devices.radius.encryption_key_version, null) == null ? sensitive(try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null) != null ? try(each.value.radius.encryption_key, local.defaults.ise.network_resources.network_devices.radius.encryption_key, null) : null) : null
  authentication_encryption_key_wo                         = try(each.value.radius.encryption_key_version, local.defaults.ise.network_resources.network_devices.radius.encryption_key_version, null) == null ? null : sensitive(try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null) != null ? try(each.value.radius.encryption_key, local.defaults.ise.network_resources.network_devices.radius.encryption_key, null) : null)
  authentication_encryption_key_wo_version                 = try(each.value.radius.encryption_key_version, local.defaults.ise.network_resources.network_devices.radius.encryption_key_version, null)
  ...
  authentication_message_authenticator_code_key            = try(each.value.radius.message_authenticator_code_key_version, local.defaults.ise.network_resources.network_devices.radius.message_authenticator_code_key_version, null) == null ? sensitive(try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null) != null ? try(each.value.radius.message_authenticator_code_key, local.defaults.ise.network_resources.network_devices.radius.message_authenticator_code_key, null) : null) : null
  authentication_message_authenticator_code_key_wo         = try(each.value.radius.message_authenticator_code_key_version, local.defaults.ise.network_resources.network_devices.radius.message_authenticator_code_key_version, null) == null ? null : sensitive(try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null) != null ? try(each.value.radius.message_authenticator_code_key, local.defaults.ise.network_resources.network_devices.radius.message_authenticator_code_key, null) : null)
  authentication_message_authenticator_code_key_wo_version = try(each.value.radius.message_authenticator_code_key_version, local.defaults.ise.network_resources.network_devices.radius.message_authenticator_code_key_version, null)
  ...
  authentication_radius_shared_secret                      = try(each.value.radius.shared_secret_version, local.defaults.ise.network_resources.network_devices.radius.shared_secret_version, null) == null ? sensitive(try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null)) : null
  authentication_radius_shared_secret_wo                   = try(each.value.radius.shared_secret_version, local.defaults.ise.network_resources.network_devices.radius.shared_secret_version, null) == null ? null : sensitive(try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null))
  authentication_radius_shared_secret_wo_version           = try(each.value.radius.shared_secret_version, local.defaults.ise.network_resources.network_devices.radius.shared_secret_version, null)
  ...
  authentication_second_radius_shared_secret               = try(each.value.radius.second_shared_secret_version, local.defaults.ise.network_resources.network_devices.radius.second_shared_secret_version, null) == null ? sensitive(try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null) != null ? try(each.value.radius.second_shared_secret, local.defaults.ise.network_resources.network_devices.radius.second_shared_secret, null) : null) : null
  authentication_second_radius_shared_secret_wo            = try(each.value.radius.second_shared_secret_version, local.defaults.ise.network_resources.network_devices.radius.second_shared_secret_version, null) == null ? null : sensitive(try(each.value.radius.shared_secret, local.defaults.ise.network_resources.network_devices.radius.shared_secret, null) != null ? try(each.value.radius.second_shared_secret, local.defaults.ise.network_resources.network_devices.radius.second_shared_secret, null) : null)
  authentication_second_radius_shared_secret_wo_version    = try(each.value.radius.second_shared_secret_version, local.defaults.ise.network_resources.network_devices.radius.second_shared_secret_version, null)
  ...
  snmp_auth_password                                          = try(each.value.snmp.auth_password_version, local.defaults.ise.network_resources.network_devices.snmp.auth_password_version, null) == null ? sensitive(local.network_device_snmp_configured[each.key] ? try(each.value.snmp.auth_password, local.defaults.ise.network_resources.network_devices.snmp.auth_password, null) : null) : null
  snmp_auth_password_wo                                       = try(each.value.snmp.auth_password_version, local.defaults.ise.network_resources.network_devices.snmp.auth_password_version, null) == null ? null : sensitive(local.network_device_snmp_configured[each.key] ? try(each.value.snmp.auth_password, local.defaults.ise.network_resources.network_devices.snmp.auth_password, null) : null)
  snmp_auth_password_wo_version                               = try(each.value.snmp.auth_password_version, local.defaults.ise.network_resources.network_devices.snmp.auth_password_version, null)
  ...
  snmp_privacy_password                                       = try(each.value.snmp.privacy_password_version, local.defaults.ise.network_resources.network_devices.snmp.privacy_password_version, null) == null ? sensitive(local.network_device_snmp_configured[each.key] ? try(each.value.snmp.privacy_password, local.defaults.ise.network_resources.network_devices.snmp.privacy_password, null) : null) : null
  snmp_privacy_password_wo                                    = try(each.value.snmp.privacy_password_version, local.defaults.ise.network_resources.network_devices.snmp.privacy_password_version, null) == null ? null : sensitive(local.network_device_snmp_configured[each.key] ? try(each.value.snmp.privacy_password, local.defaults.ise.network_resources.network_devices.snmp.privacy_password, null) : null)
  snmp_privacy_password_wo_version                            = try(each.value.snmp.privacy_password_version, local.defaults.ise.network_resources.network_devices.snmp.privacy_password_version, null)
  ...
  tacacs_shared_secret                                        = try(each.value.tacacs.shared_secret_version, local.defaults.ise.network_resources.network_devices.tacacs.shared_secret_version, null) == null ? sensitive(try(each.value.tacacs.shared_secret, local.defaults.ise.network_resources.network_devices.tacacs.shared_secret, null)) : null
  tacacs_shared_secret_wo                                     = try(each.value.tacacs.shared_secret_version, local.defaults.ise.network_resources.network_devices.tacacs.shared_secret_version, null) == null ? null : sensitive(try(each.value.tacacs.shared_secret, local.defaults.ise.network_resources.network_devices.tacacs.shared_secret, null))
  tacacs_shared_secret_wo_version                             = try(each.value.tacacs.shared_secret_version, local.defaults.ise.network_resources.network_devices.tacacs.shared_secret_version, null)
  ...
  trustsec_device_password                                    = try(each.value.trust_sec.device_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.device_password_version, null) == null ? sensitive(try(each.value.trust_sec.device_id, local.defaults.ise.network_resources.network_devices.trust_sec.device_id, null) != null ? try(each.value.trust_sec.device_password, local.defaults.ise.network_resources.network_devices.trust_sec.device_password, null) : null) : null
  trustsec_device_password_wo                                 = try(each.value.trust_sec.device_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.device_password_version, null) == null ? null : sensitive(try(each.value.trust_sec.device_id, local.defaults.ise.network_resources.network_devices.trust_sec.device_id, null) != null ? try(each.value.trust_sec.device_password, local.defaults.ise.network_resources.network_devices.trust_sec.device_password, null) : null)
  trustsec_device_password_wo_version                         = try(each.value.trust_sec.device_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.device_password_version, null)
  ...
  trustsec_rest_api_password                                  = try(each.value.trust_sec.rest_api_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.rest_api_password_version, null) == null ? sensitive(try(each.value.trust_sec.device_id, local.defaults.ise.network_resources.network_devices.trust_sec.device_id, null) != null ? try(each.value.trust_sec.rest_api_password, local.defaults.ise.network_resources.network_devices.trust_sec.rest_api_password, null) : null) : null
  trustsec_rest_api_password_wo                               = try(each.value.trust_sec.rest_api_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.rest_api_password_version, null) == null ? null : sensitive(try(each.value.trust_sec.device_id, local.defaults.ise.network_resources.network_devices.trust_sec.device_id, null) != null ? try(each.value.trust_sec.rest_api_password, local.defaults.ise.network_resources.network_devices.trust_sec.rest_api_password, null) : null)
  trustsec_rest_api_password_wo_version                       = try(each.value.trust_sec.rest_api_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.rest_api_password_version, null)
  trustsec_enable_mode_password                               = try(each.value.trust_sec.enable_mode_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.enable_mode_password_version, null) == null ? sensitive(try(each.value.trust_sec.device_id, local.defaults.ise.network_resources.network_devices.trust_sec.device_id, null) != null ? try(each.value.trust_sec.enable_mode_password, local.defaults.ise.network_resources.network_devices.trust_sec.enable_mode_password, null) : null) : null
  trustsec_enable_mode_password_wo                            = try(each.value.trust_sec.enable_mode_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.enable_mode_password_version, null) == null ? null : sensitive(try(each.value.trust_sec.device_id, local.defaults.ise.network_resources.network_devices.trust_sec.device_id, null) != null ? try(each.value.trust_sec.enable_mode_password, local.defaults.ise.network_resources.network_devices.trust_sec.enable_mode_password, null) : null)
  trustsec_enable_mode_password_wo_version                    = try(each.value.trust_sec.enable_mode_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.enable_mode_password_version, null)
  trustsec_exec_mode_password                                 = try(each.value.trust_sec.exec_mode_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.exec_mode_password_version, null) == null ? sensitive(try(each.value.trust_sec.device_id, local.defaults.ise.network_resources.network_devices.trust_sec.device_id, null) != null ? try(each.value.trust_sec.exec_mode_password, local.defaults.ise.network_resources.network_devices.trust_sec.exec_mode_password, null) : null) : null
  trustsec_exec_mode_password_wo                              = try(each.value.trust_sec.exec_mode_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.exec_mode_password_version, null) == null ? null : sensitive(try(each.value.trust_sec.device_id, local.defaults.ise.network_resources.network_devices.trust_sec.device_id, null) != null ? try(each.value.trust_sec.exec_mode_password, local.defaults.ise.network_resources.network_devices.trust_sec.exec_mode_password, null) : null)
  trustsec_exec_mode_password_wo_version                      = try(each.value.trust_sec.exec_mode_password_version, local.defaults.ise.network_resources.network_devices.trust_sec.exec_mode_password_version, null)
